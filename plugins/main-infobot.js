...
await conn.reply(m.chat, teks, m, { contextInfo: { mentionedJid: [owner[0][0] + '@s.whatsapp.net'], externalAdReply: { mediaUrl: false, mediaType: 1, description: false, title: 'Info Bot',body: false, previewType: 0, thumbnail: miniurl, sourceUrl: 'https://chat.whatsapp.com/J1R402WH1N0Hdl3S0NDEYu'}}})
}
handler.help = ['info']
handler.tags = ['main']
